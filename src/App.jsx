...
const s = {
  ...
  stepDot: { width: 28, height: 28, borderRadius: "50%", border: "2px solid #333333", background: "#1A1A1A", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 600, color: "#6B7280", zIndex: 1 },
  ...
  input: { padding: "10px 12px", border: "1px solid #333333", borderRadius: 8, fontSize: 14, fontFamily: "inherit", outline: "none", transition: "border 0.15s", boxSizing: "border-box", width: "100%", background: "#141414", color: "#F9FAFB" },
  ...
  confirmCard: { border: "1px solid #2A2A2A", borderRadius: 8, overflow: "hidden" },
  confirmRow: { display: "flex", justifyContent: "space-between", padding: "12px 16px", borderBottom: "1px solid #222222" },
  ...
  btnSecondary: { padding: "11px 20px", background: "#1A1A1A", color: "#D1D5DB", border: "1px solid #333333", borderRadius: 8, fontSize: 14, fontWeight: 500, cursor: "pointer", fontFamily: "inherit" },
  btnDisabled: { opacity: 0.4, cursor: "not-allowed" },
  errorBox: { background: "#3B0000", color: "#FCA5A5", padding: "12px 14px", borderRadius: 8, fontSize: 13 },
  successIcon: { width: 56, height: 56, borderRadius: "50%", background: "#1C1007", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, margin: "0 auto 20px", color: "#F97316" },
  ...
  refreshBtn: { padding: "8px 16px", background: "#1A1A1A", border: "1px solid #2A2A2A", borderRadius: 8, cursor: "pointer", fontSize: 14, color: "#D1D5DB", fontFamily: "inherit" },
  statsRow: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 20 },
  statCard: { background: "#1A1A1A", border: "1px solid #2A2A2A", borderRadius: 10, padding: "16px", display: "flex", flexDirection: "column", alignItems: "center", gap: 4 },
  ...
  filterBtn: { padding: "6px 14px", borderRadius: 20, border: "1px solid #2A2A2A", background: "#1A1A1A", cursor: "pointer", fontSize: 12, fontWeight: 600, color: "#9CA3AF", textTransform: "capitalize", fontFamily: "inherit" },
  filterBtnActive: { background: "#1C1007", color: "#F97316", borderColor: "#7C2D12" },
  bookingList: { display: "flex", flexDirection: "column", gap: 12 },
  bookingCard: { background: "#1A1A1A", border: "1px solid #2A2A2A", borderRadius: 10, padding: "16px 20px" },
  ...
  bookingBody: { display: "flex", flexDirection: "column", gap: 4, marginBottom: 14, paddingBottom: 14, borderBottom: "1px solid #222222" },
  ...
  statusSelect: { padding: "6px 10px", border: "1px solid #333333", borderRadius: 6, fontSize: 13, fontFamily: "inherit", cursor: "pointer", background: "#141414", color: "#F9FAFB" },
};
